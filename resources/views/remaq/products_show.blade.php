...
<body data-spy="scroll" data-target="#navbar-example">
  ...
  <!-- header end -->
    ...
    <div id="show" class="show-area fix" style="padding-top: 80px">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-4">
                    <img src="{{ asset('img/products'. $products->img_name) }}" style="width: 80%; height: 80% ;"alt="">
                </div>
                <div class="col-md-8">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="7" cols="50" readonly>{{ $products->descripcion }}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="form contact-form">
                            <div class="text-center"><button type="submit" data-toggle="modal" data-target="#contactanos">Solicitar Cotización</button></div>
                        </div>
                    </div>
                </div>
            </div>

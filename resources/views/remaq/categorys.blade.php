      ...
      <br>
        ...
        <div class="col-md-4 text-center">
            <div class="col-md-12">
                ...
                @endif<img src="{{ asset('img/portfolio'. $category->img_name) }}" width="200px" height="200px"  alt=""></a>
              <p>{{$category->name}}</p>
            </div>
            <div class="col-xs-8 col-xs-offset-2">
                @if ($category->products_count > 0)
                <a href="{{route('show.products_by_category', $category)}}" class="btn btn-info pull-left">Ver mas</a>
                <a href="#contactanos" class="btn btn-info pull-right" data-toggle="modal" data-target="#contactanos">Cotizar</a>
                @else
                <a href="#contactanos" class="btn btn-info" data-toggle="modal" data-target="#contactanos">Cotizar</a>
                @endif
            </div>
        </div>
